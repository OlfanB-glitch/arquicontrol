...
async def list_contratistas(current_user: UserResponse = Depends(get_current_user)):
    return await contratista_service.list_all(current_user.id)
...
async def create_contratista(
    ...
    return await contratista_service.create(payload, current_user.id)
...
async def update_contratista(
    ...
    return await contratista_service.update(contratista_id, payload, current_user.id)
